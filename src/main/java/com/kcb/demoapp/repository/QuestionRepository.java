...
public interface QuestionRepository extends JpaRepository<Question,String> {
    ...
    List<Question> search(@Param("category") String category, @Param("tags") List<String> tags, @Param("complexity") String complexity, @Param("questionType") String questionType);
}
